...
//            }
    ...
    public BlockPlacementStatus verifyBlockPlacement(DatanodeInfo[] locs,
        ...
        BlockPlacementStatus defaultStatus = super.verifyBlockPlacement(locs,
                numberOfReplicas);
        BlockPlacementStatusWithUpgradeDomain2 upgradeDomainStatus =
                new BlockPlacementStatusWithUpgradeDomain2(defaultStatus,
...
//        }
//    }
// hack: balancer can move any blocks as default policy wishes.
// we assume single-rack config
//
//    @Override
